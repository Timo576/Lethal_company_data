...
public class NutcrackerEnemyAI : EnemyAI
{
      ...
      case 2:
        ...
        if ((double) this.timeSinceSeeingTarget > 12.0)
        {
          if (this.reloadingGun || (double) this.timeSinceFiringGun <= 0.5)
            break;
          Debug.Log((object) string.Format("Switching state to 1 from attack mode; time since seeing target: {0}", (object) this.timeSinceSeeingTarget));
  ...
  private bool GrabGunIfNotHolding()
  {
    ...
    {
      Debug.Log((object) string.Format("Nutcracker: Found spawned gun with id {0}. Grabbing", (object) networkObject.NetworkObjectId));
  ...
  public void TurnTorsoToTargetDegrees()
  {
    ...
    Debug.Log((object) string.Format("dist to target torso degrees: {0}", (object) Mathf.Abs(this.currentTorsoRotation - (float) this.targetTorsoDegrees)));
  ...
  public override void Update()
  {
    ...
    else
    {
      ...
      if ((double) this.walkCheckInterval <= 0.0)
      {
        ...
        this.creatureAnimator.SetBool("IsWalking", (double) (this.transform.position - this.positionLastCheck).sqrMagnitude > 0.0099999997764825821);
  ...
  private IEnumerator AimGun(Vector3 enemyPos)
  {
    ...
    nutcrackerEnemyAi.agent.speed = 0.0f;
    nutcrackerEnemyAi.inSpecialAnimation = true;
    nutcrackerEnemyAi.serverPosition = enemyPos;
    Debug.Log((object) nutcrackerEnemyAi.gun.shellsLoaded);
  ...
  private IEnumerator waitToFireGun()
  {
    ...
    yield return (object) new WaitUntil(new Func<bool>(nutcrackerEnemyAi.\u003CwaitToFireGun\u003Eb__76_0));
    yield return (object) new WaitForSeconds(0.5f);
  ...
  public override void HitEnemy(int force = 1, PlayerControllerB playerWhoHit = null, bool playHitSFX = false)
  {
    ...
    if ((UnityEngine.Object) playerWhoHit != (UnityEngine.Object) null)
      this.SeeMovingThreatServerRpc((int) playerWhoHit.playerClientId);
