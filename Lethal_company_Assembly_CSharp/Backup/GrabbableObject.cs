...
public abstract class GrabbableObject : NetworkBehaviour
{
  ...
  public virtual void Start()
  {
    ...
    {
      Debug.Log((object) "Setting fallTmie to 1");
      this.fallTime = 1f;
      this.hasHitGround = true;
    }
  ...
  public virtual void Update()
  {
    ...
    {
      Debug.Log((object) string.Format("Object {0} falling {1}", (object) this.itemProperties.itemName, (object) this.fallTime));
      this.reachedFloorTarget = false;
      this.FallWithCurve();
      if ((double) this.transform.localPosition.y - (double) this.targetFloorPosition.y >= 0.10000000149011612)
        return;
      Debug.Log((object) string.Format("Object {0}hit ground false? : {1}", (object) this.itemProperties.itemName, (object) this.hasHitGround));
  ...
  {
    Debug.Log((object) ("Object " + this.itemProperties.itemName + "hitting ground"));
    if ((UnityEngine.Object) this.itemProperties.dropSFX != (UnityEngine.Object) null)
    {
      Debug.Log((object) ("Object " + this.itemProperties.itemName + " playing drop sfx"));
