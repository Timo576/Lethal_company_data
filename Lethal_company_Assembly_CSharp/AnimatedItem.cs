...
public class AnimatedItem : GrabbableObject
{
  ...
  public override void Start()
  {
    ...
    Debug.Log((object) string.Format("Seed: {0} + {1} + {2}", (object) StartOfRound.Instance.randomMapSeed, (object) StartOfRound.Instance.currentLevelID, (object) this.itemProperties.itemId));
