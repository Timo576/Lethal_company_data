...
public class FloodWeather : MonoBehaviour
{
  ...
  private void OnEnable()
  {
    if ((Object) TimeOfDay.Instance == (Object) null)
      return;
    this.transform.position = new Vector3(0.0f, (float) TimeOfDay.Instance.currentWeatherVariable, 0.0f);
  ...
  {
    this.floodLevelOffset = Mathf.Clamp(TimeOfDay.Instance.globalTime / 1080f, 0.0f, 100f) * (float) TimeOfDay.Instance.currentWeatherVariable2;
  }
  ...
  private void Update()
  {
    if ((Object) TimeOfDay.Instance == (Object) null)
      return;
    this.transform.position = Vector3.MoveTowards(this.transform.position, new Vector3(0.0f, (float) TimeOfDay.Instance.currentWeatherVariable, 0.0f) + Vector3.up * this.floodLevelOffset, 0.5f * Time.deltaTime);
