...
// Type: Dissonance.Integrations.Unity_NFGO.NfgoPlayer
...
namespace Dissonance.Integrations.Unity_NFGO
{
  ...
  public class NfgoPlayer : NetworkBehaviour, IDissonancePlayer
  {
    ...
    public void VoiceChatTrackingStart()
    {
      ...
      if ((UnityEngine.Object) this._comms == (UnityEngine.Object) null)
        throw NfgoPlayer.Log.CreateUserErrorException("cannot find DissonanceComms component in scene", "not placing a DissonanceComms component on a game object in the scene", "https://placeholder-software.co.uk/dissonance/docs/Basics/Quick-Start-UNet-HLAPI.html", "A6A291D8-5B53-417E-95CD-EC670637C532");
    ...
    public void SetNameServerRpc(string playerName)
    {
      ...
      if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Server && (networkManager.IsClient || networkManager.IsHost))
      {
        ...
        FastBufferWriter bufferWriter = this.__beginSendServerRpc(2083405329U, serverRpcParams, RpcDelivery.Reliable);
        ...
        this.__endSendServerRpc(ref bufferWriter, 2083405329U, serverRpcParams, RpcDelivery.Reliable);
      }
    ...
    {
      if (this.IsTracking)
        throw NfgoPlayer.Log.CreatePossibleBugException("Attempting to start player tracking, but tracking is already started", "4C2E74AA-CA09-4F98-B820-F2518A4E87D2");
      if (!((UnityEngine.Object) this._comms != (UnityEngine.Object) null))
        return;
    ...
    {
      if (!this.IsTracking)
        throw NfgoPlayer.Log.CreatePossibleBugException("Attempting to stop player tracking, but tracking is not started", "BF8542EB-C13E-46FA-A8A0-B162F188BBA3");
      if (!((UnityEngine.Object) this._comms != (UnityEngine.Object) null))
        return;
    ...
    internal static void InitializeRPCS_NfgoPlayer()
    {
      ...
      __nonvirtual (NetworkManager.__rpc_func_table.Add(2083405329U, new NetworkManager.RpcReceiveHandler(NfgoPlayer.__rpc_handler_2083405329)));
    }

    private static void __rpc_handler_2083405329(
    ...
    protected internal override string __getTypeName() => nameof (NfgoPlayer);
  }
}
