...
public class StartOfRound : NetworkBehaviour
{
  ...
  public void BuyShipUnlockableServerRpc(int unlockableID, int newGroupCreditsAmount)
  {
    ...
    if (this.unlockablesList.unlockables[unlockableID].hasBeenUnlockedByPlayer)
    {
  ...
  private void LoadUnlockables()
  {
    try
    {
      ...
      {
        if (this.unlockablesList.unlockables[index].alreadyUnlocked && !this.unlockablesList.unlockables[index].IsPlaceable)
  ...
  private void SetTimeAndPlanetToSavedSettings()
  {
    ...
    this.ChangeLevel(ES3.Load<int>("CurrentPlanetID", currentSaveFileName, this.defaultPlanet));
    this.ChangePlanet();
  ...
  public void OnClientConnect(ulong clientId)
  {
    ...
    try
    {
      ...
      this.OnPlayerConnectedClientRpc(clientId, this.connectedPlayersAmount, ulongList.ToArray(), assignedPlayerObjectId, groupCredits, this.currentLevelID, profitQuota, timeUntilDeadline, quotaFulfilled, this.randomMapSeed);
    ...
    int randomSeed)
  {
    ...
    {
      ClientRpcParams clientRpcParams;
      FastBufferWriter bufferWriter = this.__beginSendClientRpc(1161314225U, clientRpcParams, RpcDelivery.Reliable);
      BytePacker.WriteValueBitPacked(bufferWriter, clientId);
      ...
      this.__endSendClientRpc(ref bufferWriter, 1161314225U, clientRpcParams, RpcDelivery.Reliable);
    }
    if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Client || !networkManager.IsClient && !networkManager.IsHost)
      return;
    try
  ...
  private IEnumerator gameOverAnimation(bool leavingOnMidnight)
  {
    ...
    yield return (object) new WaitUntil(new Func<bool>(startOfRound.\u003CgameOverAnimation\u003Eb__236_0));
  ...
  private IEnumerator OpenShipDoors()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    yield return (object) new WaitUntil(new Func<bool>(startOfRound.\u003COpenShipDoors\u003Eb__240_0));
  ...
  private IEnumerator unloadSceneForAllPlayers()
  {
    ...
    yield return (object) null;
    // ISSUE: reference to a compiler-generated method
    yield return (object) new WaitUntil(new Func<bool>(startOfRound.\u003CunloadSceneForAllPlayers\u003Eb__249_0));
    ...
    startOfRound.EndOfGameClientRpc(bodiesInShip, startOfRound.daysPlayersSurvivedInARow, startOfRound.connectedPlayersAmount);
  }
    ...
    int connectedPlayersOnServer)
  {
    ...
    {
      ClientRpcParams clientRpcParams;
      FastBufferWriter bufferWriter = this.__beginSendClientRpc(52779490U, clientRpcParams, RpcDelivery.Reliable);
      ...
      this.__endSendClientRpc(ref bufferWriter, 52779490U, clientRpcParams, RpcDelivery.Reliable);
    }
    if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Client || !networkManager.IsClient && !networkManager.IsHost)
      return;
    ...
    if (this.currentLevel.planetHasTime)
    {
      ...
      HUDManager.Instance.FillEndGameStats(this.gameStats);
    }
    ...
    this.StartCoroutine(this.EndOfGame(bodiesInsured, connectedPlayersOnServer));
  }
  ...
  private IEnumerator EndOfGame(int bodiesInsured = 0, int connectedPlayersOnServer = 0)
  {
    ...
    TimeOfDay.Instance.currentWeatherVariable2 = 0;
    ...
    if (startOfRound.IsServer)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      yield return (object) new WaitUntil(new Func<bool>(startOfRound.\u003CEndOfGame\u003Eb__255_0));
      startOfRound.playersRevived = 0;
      bool flag = (double) TimeOfDay.Instance.timeUntilDeadline <= 0.0;
      if ((double) (TimeOfDay.Instance.profitQuota - TimeOfDay.Instance.quotaFulfilled) <= 0.0)
      {
  ...
  public void ManuallyEjectPlayersServerRpc()
  {
    ...
    if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Server || !networkManager.IsServer && !networkManager.IsHost || !this.inShipPhase || this.firingPlayersCutsceneRunning || this.fullyLoadedPlayers.Count < GameNetworkManager.Instance.connectedPlayers)
      return;
    GameNetworkManager.Instance.gameHasStarted = true;
  ...
  private IEnumerator playersFiredGameOver(bool abridgedVersion)
  {
    ...
    if (startOfRound.IsServer)
    {
      ++startOfRound.playersRevived;
      // ISSUE: reference to a compiler-generated method
      yield return (object) new WaitUntil(new Func<bool>(startOfRound.\u003CplayersFiredGameOver\u003Eb__263_0));
      startOfRound.playersRevived = 0;
  ...
  public void ResetShip()
  {
    ...
    Debug.Log((object) "Reset ship B: Going to reset unlockables list!");
    GameNetworkManager.Instance.ResetUnlockablesListValues();
    Debug.Log((object) "Reset ship C: Reset unlockables list!");
    for (int index = 0; index < this.unlockablesList.unlockables.Count; ++index)
      Debug.Log((object) string.Format("Unl {0} in stor: {1}", (object) this.unlockablesList.unlockables[index].unlockableName, (object) this.unlockablesList.unlockables[index].inStorage));
    for (int index = 0; index < this.allPlayerScripts.Length; ++index)
    {
  ...
  private void SetShipReadyToLand()
  {
    ...
    this.shipLeftAutomatically = false;
    this.allScrapValueCollected = this.GetValueOfAllScrap();
    this.SetDiscordStatusDetails();
  ...
  public void ChangeLevelServerRpc(int levelID, int newGroupCreditsAmount)
  {
    ...
    if (!this.travellingToNewLevel && this.inShipPhase)
    {
      UnityEngine.Object.FindObjectOfType<Terminal>().groupCredits = newGroupCreditsAmount;
  ...
  public void SetMapScreenInfoToCurrentLevel()
  {
    ...
    this.screenLevelDescription.text = "Orbiting: " + this.currentLevel.PlanetName + "\n" + this.currentLevel.LevelDescription + "\n" + (this.currentLevel.currentWeather == LevelWeatherType.None ? "" : "Weather: " + this.currentLevel.currentWeather.ToString());
    ...
    if (!((UnityEngine.Object) this.currentLevel.videoReel != (UnityEngine.Object) null))
      return;
  ...
  public int GetValueOfAllScrap(bool onlyScrapCollected = true)
  {
    ...
    for (int index = 0; index < objectsOfType.Length; ++index)
    {
      if (objectsOfType[index].itemProperties.isScrap && (objectsOfType[index].isInShipRoom || !onlyScrapCollected))
  ...
  internal static void InitializeRPCS_StartOfRound()
  {
    ...
    // ISSUE: explicit non-virtual call
    __nonvirtual (NetworkManager.__rpc_func_table.Add(1161314225U, new NetworkManager.RpcReceiveHandler(StartOfRound.__rpc_handler_1161314225)));
    // ISSUE: explicit non-virtual call
    ...
    // ISSUE: explicit non-virtual call
    __nonvirtual (NetworkManager.__rpc_func_table.Add(52779490U, new NetworkManager.RpcReceiveHandler(StartOfRound.__rpc_handler_52779490)));
    // ISSUE: explicit non-virtual call
  ...
  private static void __rpc_handler_1161314225(
    NetworkBehaviour target,
    FastBufferReader reader,
    __RpcParams rpcParams)
  {
    ...
    target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.Client;
    ((StartOfRound) target).OnPlayerConnectedClientRpc(clientId, connectedPlayers, connectedPlayerIdsOrdered, assignedPlayerObjectId, serverMoneyAmount, levelID, profitQuota, timeUntilDeadline, quotaFulfilled, randomSeed);
    target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.None;
  }
  ...
  private static void __rpc_handler_52779490(
    NetworkBehaviour target,
    FastBufferReader reader,
    __RpcParams rpcParams)
  {
    ...
    target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.Client;
    ((StartOfRound) target).EndOfGameClientRpc(bodiesInsured, daysPlayersSurvived, connectedPlayersOnServer);
    target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.None;
  }
