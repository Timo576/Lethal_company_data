  ...
  public class PlayerControllerB : NetworkBehaviour, IHittable, IShockableWithGun, IVisibleThreat
  {
      ...
      bool isPlayerGrounded)
    {
      ...
      if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Server && (networkManager.IsClient || networkManager.IsHost))
      {
        ...
        ServerRpcParams serverRpcParams;
        FastBufferWriter bufferWriter = this.__beginSendServerRpc(2013428264U, serverRpcParams, RpcDelivery.Reliable);
        bufferWriter.WriteValueSafe(in newPos);
        bufferWriter.WriteValueSafe<bool>(in inElevator, new FastBufferWriter.ForPrimitives());
        bufferWriter.WriteValueSafe<bool>(in inShipRoom, new FastBufferWriter.ForPrimitives());
        ...
        this.__endSendServerRpc(ref bufferWriter, 2013428264U, serverRpcParams, RpcDelivery.Reliable);
      }
      if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Server || !networkManager.IsServer && !networkManager.IsHost)
        return;
      try
      {
        this.UpdatePlayerPositionClientRpc(newPos, inElevator, inShipRoom, exhausted, isPlayerGrounded);
      }
      catch (Exception ex)
      {
      ...
      bool isPlayerGrounded)
    {
      ...
      {
        ClientRpcParams clientRpcParams;
        FastBufferWriter bufferWriter = this.__beginSendClientRpc(1048810471U, clientRpcParams, RpcDelivery.Reliable);
        bufferWriter.WriteValueSafe(in newPos);
        bufferWriter.WriteValueSafe<bool>(in inElevator, new FastBufferWriter.ForPrimitives());
        bufferWriter.WriteValueSafe<bool>(in isInShip, new FastBufferWriter.ForPrimitives());
        bufferWriter.WriteValueSafe<bool>(in exhausted, new FastBufferWriter.ForPrimitives());
        bufferWriter.WriteValueSafe<bool>(in isPlayerGrounded, new FastBufferWriter.ForPrimitives());
        this.__endSendClientRpc(ref bufferWriter, 1048810471U, clientRpcParams, RpcDelivery.Reliable);
      }
      if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Client || !networkManager.IsClient && !networkManager.IsHost)
        return;
      ...
      this.isInHangarShipRoom = isInShip;
      for (int index = 0; index < this.ItemSlots.Length; ++index)
      {
        if ((UnityEngine.Object) this.ItemSlots[index] != (UnityEngine.Object) null && this.ItemSlots[index].isHeld)
        {
          if (this.ItemSlots[index].isInShipRoom != isInShip)
            this.SetItemInElevator(isInShip, this.isInElevator, this.ItemSlots[index]);
          this.ItemSlots[index].isInElevator = inElevator;
        }
      }
    ...
    private void PlayerHitGroundEffects()
    {
      ...
      {
        Debug.Log((object) string.Format("Fall damage: {0}", (object) this.fallValueUncapped));
        if ((double) this.fallValueUncapped < -48.5)
          this.DamagePlayer(100, causeOfDeath: CauseOfDeath.Gravity);
        else if ((double) this.fallValueUncapped < -45.0)
          this.DamagePlayer(80, causeOfDeath: CauseOfDeath.Gravity);
        else if ((double) this.fallValueUncapped < -40.0)
          this.DamagePlayer(50, causeOfDeath: CauseOfDeath.Gravity);
        else
          this.DamagePlayer(30, causeOfDeath: CauseOfDeath.Gravity);
      }
      if ((double) this.fallValue >= -16.0)
        return;
      ...
      if (this.IsOwner && this.isPlayerControlled && (!this.IsServer || this.isHostPlayerObject) || this.isTestingPlayer)
      {
        ...
        if (!this.inSpecialInteractAnimation || this.inShockingMinigame)
        {
          if (!this.thisController.isGrounded)
          {
            ...
            if ((double) this.fallValueUncapped < -35.0)
        ...
        if (this.isHoldingObject && (UnityEngine.Object) this.currentlyHeldObjectServer == (UnityEngine.Object) null)
          this.DropAllHeldItems();
    ...
    {
      this.DropAllHeldItems();
      this.DropAllHeldItemsServerRpc();
    }
    ...
    public void DropAllHeldItemsServerRpc()
    {
      ...
      {
        ServerRpcParams serverRpcParams;
        FastBufferWriter bufferWriter = this.__beginSendServerRpc(760742013U, serverRpcParams, RpcDelivery.Reliable);
        this.__endSendServerRpc(ref bufferWriter, 760742013U, serverRpcParams, RpcDelivery.Reliable);
      }
      if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Server || !networkManager.IsServer && !networkManager.IsHost)
        return;
      this.DropAllHeldItemsClientRpc();
    }
    ...
    public void DropAllHeldItemsClientRpc()
    {
      ...
      {
        ClientRpcParams clientRpcParams;
        FastBufferWriter bufferWriter = this.__beginSendClientRpc(2096889309U, clientRpcParams, RpcDelivery.Reliable);
        this.__endSendClientRpc(ref bufferWriter, 2096889309U, clientRpcParams, RpcDelivery.Reliable);
      }
      if (this.__rpc_exec_stage != NetworkBehaviour.__RpcExecStage.Client || !networkManager.IsClient && !networkManager.IsHost)
        return;
      this.DropAllHeldItems();
    ...
    private IEnumerator WaitUntilPlayerHasLeftBodyToTeleport(Vector3 newBodyPosition)
    {
      PlayerControllerB playerControllerB = this;
      // ISSUE: reference to a compiler-generated method
      yield return (object) new WaitUntil(new Func<bool>(playerControllerB.\u003CWaitUntilPlayerHasLeftBodyToTeleport\u003Eb__458_0));
        ...
        if (this.isPlayerControlled && !this.isPlayerDead)
        {
          if ((UnityEngine.Object) GameNetworkManager.Instance != (UnityEngine.Object) null)
          {
            if ((double) (this.oldPlayerPosition - this.transform.localPosition).sqrMagnitude > (!this.inSpecialInteractAnimation ? (!this.NearOtherPlayers(this) ? 0.23999999463558197 : 0.10000000149011612) : 0.059999998658895493) || this.updatePositionForNewlyJoinedClient)
            {
              ...
              {
                this.UpdatePlayerPositionServerRpc(this.thisPlayerBody.localPosition, this.isInElevator, this.isInHangarShipRoom, this.isExhausted, this.thisController.isGrounded);
    ...
    internal static void InitializeRPCS_PlayerControllerB()
    {
      ...
      // ISSUE: explicit non-virtual call
      __nonvirtual (NetworkManager.__rpc_func_table.Add(2013428264U, new NetworkManager.RpcReceiveHandler(PlayerControllerB.__rpc_handler_2013428264)));
      // ISSUE: explicit non-virtual call
      __nonvirtual (NetworkManager.__rpc_func_table.Add(1048810471U, new NetworkManager.RpcReceiveHandler(PlayerControllerB.__rpc_handler_1048810471)));
      // ISSUE: explicit non-virtual call
      ...
      // ISSUE: explicit non-virtual call
      __nonvirtual (NetworkManager.__rpc_func_table.Add(760742013U, new NetworkManager.RpcReceiveHandler(PlayerControllerB.__rpc_handler_760742013)));
      // ISSUE: explicit non-virtual call
      __nonvirtual (NetworkManager.__rpc_func_table.Add(2096889309U, new NetworkManager.RpcReceiveHandler(PlayerControllerB.__rpc_handler_2096889309)));
      // ISSUE: explicit non-virtual call
    ...
    private static void __rpc_handler_2013428264(
      NetworkBehaviour target,
      FastBufferReader reader,
      __RpcParams rpcParams)
    {
      ...
      else
      {
        ...
        bool inShipRoom;
        reader.ReadValueSafe<bool>(out inShipRoom, new FastBufferWriter.ForPrimitives());
        bool exhausted;
        ...
        target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.Server;
        ((PlayerControllerB) target).UpdatePlayerPositionServerRpc(newPos, inElevator, inShipRoom, exhausted, isPlayerGrounded);
        target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.None;
      }
    }

    private static void __rpc_handler_1048810471(
      NetworkBehaviour target,
      FastBufferReader reader,
      __RpcParams rpcParams)
    {
      ...
      reader.ReadValueSafe<bool>(out inElevator, new FastBufferWriter.ForPrimitives());
      bool isInShip;
      reader.ReadValueSafe<bool>(out isInShip, new FastBufferWriter.ForPrimitives());
      bool exhausted;
      reader.ReadValueSafe<bool>(out exhausted, new FastBufferWriter.ForPrimitives());
      bool isPlayerGrounded;
      reader.ReadValueSafe<bool>(out isPlayerGrounded, new FastBufferWriter.ForPrimitives());
      target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.Client;
      ((PlayerControllerB) target).UpdatePlayerPositionClientRpc(newPos, inElevator, isInShip, exhausted, isPlayerGrounded);
      target.__rpc_exec_stage = NetworkBehaviour.__RpcExecStage.None;
    }
    ...
    private static void __rpc_handler_760742013(
      NetworkBehaviour target,
      FastBufferReader reader,
      __RpcParams rpcParams)
    {
    ...
    private static void __rpc_handler_2096889309(
      NetworkBehaviour target,
      FastBufferReader reader,
      __RpcParams rpcParams)
    {
