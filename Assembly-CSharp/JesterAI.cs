...
public class JesterAI : EnemyAI
{
  ...
  public override void DoAIInterval()
  {
    ...
    switch (this.currentBehaviourStateIndex)
    {
      ...
      case 2:
        ...
        this.addPlayerVelocityToDestination = 1f;
  ...
  private void SetJesterInitialValues()
  {
    ...
    this.beginCrankingTimer = UnityEngine.Random.Range(25f, 42f);
      ...
      case 2:
        ...
        if (this.IsOwner)
        {
          if (this.inKillAnimation || (double) this.stunNormalizedTimer > 0.0)
            ...
            this.agent.speed = Mathf.Clamp(this.agent.speed + Time.deltaTime * 1.45f, 0.0f, 18f);
