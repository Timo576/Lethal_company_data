...
namespace DigitalRuby.ThunderAndLightning
{
  public abstract class LightningSpellScript : MonoBehaviour
  {
    ...
    private IEnumerator StopAfterSecondsCoRoutine(float seconds)
    {
      ...
      yield return (object) new WaitForSecondsLightning(seconds);
    ...
    {
      this.CooldownTimer = Mathf.Max(0.0f, this.CooldownTimer - LightningBoltScript.DeltaTime);
      this.DurationTimer = Mathf.Max(0.0f, this.DurationTimer - LightningBoltScript.DeltaTime);
    }
    ...
    public void ActivateSpell() => this.OnActivated();

    public void DeactivateSpell() => this.OnDeactivated();
    ...
    public bool CanCastSpell => !this.Casting && (double) this.CooldownTimer <= 0.0;
  }
}
