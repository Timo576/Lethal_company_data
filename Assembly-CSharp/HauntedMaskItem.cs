...
public class HauntedMaskItem : GrabbableObject, IVisibleThreat
{
  ...
  private void AttachToPlayerOnLocalClient()
  {
    ...
    {
      this.previousPlayerHeldBy.movementAudio.PlayOneShot(this.maskAttachAudio, 1f);
      WalkieTalkie.TransmitOneShotAudio(this.previousPlayerHeldBy.movementAudio, this.maskAttachAudio);
    }
